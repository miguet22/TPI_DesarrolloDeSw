...
const Eventos = () => {
    ...
    useEffect (() => {
        ...
        return(
          ...
          {eventos.map((evento) => (
            <div key={evento.id} className="bg-indigo-400 rounded-3xl shadow-lg max-w-sm mx-auto p-4 transform transition-transform duration-500 ease-out hover:-translate-y-2">
